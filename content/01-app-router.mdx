...
- **page.js** lets us the main content on the page

- **layout.js** provides a shared structure, to be used by one or more pages. Essentially, every visible page is a **combination of a layout and a page component**.

- We can nest directories if we want to create additional URLs. For example, if we create /src/app/about/page.js, that component will be shown when visiting www.example.com/about. The layout.js will be reused by default.
